...
Original file is located at
    https://colab.research.google.com/drive/1ctaL5rpbxbiTuKkwN9DUnwNbAMT0bYcX
"""
...
json_file = open('/content/encrypt_32_bit_final_1.2.1.json', 'r')
loaded_model_json = json_file.read()
json_file.close()

loaded_32bit_encrypter = model_from_json(loaded_model_json)
# load weights into new model
loaded_32bit_encrypter.load_weights("/content/encrypt_32_bit_final_1.2.1.h5")
print("Loaded model from disk")

# load json and create model
json_file = open('/content/encrypter_v1.2.5.json', 'r')
loaded_model_json = json_file.read()
json_file.close()

loaded_19bit_encrypter = model_from_json(loaded_model_json)
# load weights into new model
loaded_19bit_encrypter.load_weights("/content/encrypt_1.2.5.h5")
print("Loaded model from disk")
